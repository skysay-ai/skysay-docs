...
| `get_agent_catalog` | `agents:read` **or** `coverage:read` | Selectable STT/LLM/TTS providers with cost, latency, languages, streaming, runnability; supports `metered_only`. |
