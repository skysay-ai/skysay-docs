...
- [Choose a delivery profile](/docs/delivery-profiles#set-it-on-an-agent) · [Hear it before you save](/docs/delivery-profiles#hear-it-before-you-save)
...
- [Turn on acknowledgements](/docs/voice-behavior#enable-acknowledgements-on-an-agent) · [Set the delay and phrases](/docs/voice-behavior#how-the-worker-uses-it)
