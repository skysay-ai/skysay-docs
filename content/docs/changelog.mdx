...
- [Outbound permits](/docs/policy-and-outbound#choose-profiles-channels-and-countries) · [API reference](/docs/rest-endpoints#outbound-permit)
...
- [Request your outbound permit](/docs/policy-and-outbound#request-your-outbound-permit-in-the-workspace) · [Tool reference](/docs/tool-reference)
