...
### 5. Optional: add a conversation workflow
...
Once an agent has a workflow, step 6's text test refuses it; test a workflow
with its own Chat test instead, described in
...
call you started in step 6 the same way.
