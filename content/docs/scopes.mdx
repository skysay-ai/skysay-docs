...
A scope is the unit of permission on a `sky_` key. The key is the boundary: tools
...
| `onboarding:read` | Read the workspace capabilities. |
| `onboarding:write` | Request workspace capabilities. |
