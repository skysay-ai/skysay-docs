...
can reach, each marked **Available now** or **Coming soon**, and ends with
**Need another integration? Message us** — which opens support chat, or your
mail client when chat is unavailable. Naming the system you need is how it gets
onto that list.
